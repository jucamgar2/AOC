...
public class Day17 {
    ...
    public Day17(Long registerA, Long registerB, Long registerC, String[] programInstructions){
        this.registerA = registerA;
        this.registerB = registerB;
        this.registerC = registerC;
    ...
    public static Day17 getDay17Data(){
        Long registerA = 0l;
        Long registerB = 0l;
        Long registerC = 0l;
        ...
        return new Day17(registerA, registerB, registerC, programInstructions);
    }
