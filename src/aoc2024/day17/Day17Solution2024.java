...
public class Day17Solution2024 extends BaseDay{

    @Override
    protected Day17Y2024 getInputData(){
        return Day17Y2024.getDay17Data();
    }

    public void runDaySolution(){
        Day17Y2024 input = getInputData();
    ...
    protected void part1Solution(Object input) {
        System.out.println("SOLUCION: " + getProgramOutput((Day17Y2024)input));
    }

    public static String getProgramOutput(Day17Y2024 input){
        String output = "";
    ...
    public static String runInstruction(Day17Y2024 input, Integer pointer, Integer instruction, Long operand, String output){
        switch (instruction) {
            case 0:
    ...
    public static Long getComboOperand(Long operand, Day17Y2024 input){
        if(operand<4){
            return operand;
        }else if(operand ==4){
    ...
    public static void adv(Long operand, Day17Y2024 input, Integer poninter){
        input.setRegisterA(input.getRegisterA() / (long)Math.pow(2, getComboOperand(operand, input)));
    }

    public static void bdv(Long operand, Day17Y2024 input, Integer poninter){
        input.setRegisterB(input.getRegisterA() / (long)Math.pow(2, getComboOperand(operand, input)));
    }

    public static void cdv(Long operand, Day17Y2024 input, Integer poninter){
        input.setRegisterC(input.getRegisterA() / (long)Math.pow(2, getComboOperand(operand, input)));
    }

    public static void bxl(Day17Y2024 input, Long operand, Integer poninter){
        input.setRegisterB(input.getRegisterB()^operand);
    }

    public static void bst(Day17Y2024 input, Long operand, Integer poninter){
        input.setRegisterB(getComboOperand(operand, input)%8);
    }

    public static void bxc(Day17Y2024 input){
        input.setRegisterB(input.getRegisterB()^input.getRegisterC());
    }

    public static String out(Day17Y2024 input, Long operand, String output){
        output += getComboOperand(operand, input)%8 + ",";
        return output;
    }
    @Override
    protected void part2Solution(Object input) {
        Day17Y2024 parseInput = (Day17Y2024) input;
        System.out.println("SOLUCIÓN: " + findSolution(parseInput.getProgramInstructions(), 0, parseInput.getProgramInstructions()));
    }
