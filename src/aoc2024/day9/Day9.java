...
public class Day9 {
    ...
    public Day9(Map<Integer,Long> sortedMap,Map<Integer, Integer> emptyBlocks){
    ...
    public static Day9 getDay9Data(){
    ...
    public static Day9 transformDisk(String disk, Map<Integer,Integer> emptyBlocks){
        ...
        return new Day9(sortedMap, emptyBlocks);
    }
