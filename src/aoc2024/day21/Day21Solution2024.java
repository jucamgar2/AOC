...
import utils.MovePad;
import utils.Node;
import utils.NodePair;
import utils.NumericPad;

public class Day21Solution2024 extends BaseDay{

    @Override
    protected Day21Y2024 getInputData(){
        return Day21Y2024.getDay21Data();
    }

    @Override
    public void runDaySolution(){
        Day21Y2024 input = getInputData();
    ...
    protected void part1Solution(Object input) {
        System.out.println("SOLUCIÓN: " + getSumOfComplexities((Day21Y2024)input, 2));
    }

    private static long getSumOfComplexities(Day21Y2024 input, int maxDepth) {
    ...
    protected void part2Solution(Object input) {
        System.out.println("SOLUCIÓN: " + getSumOfComplexities((Day21Y2024)input, 25));
    }
}
