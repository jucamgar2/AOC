...
public class Day16Solution2024 extends BaseDay{

    @Override
    protected Day16Y2024 getInputData(){
        return Day16Y2024.getDay16Data();
    }

    public void runDaySolution(){
        Day16Y2024 input = getInputData();
    ...
    protected void part1Solution(Object input) {
        System.out.println("SOLUCION: " + getLowestScoreReindeer((Day16Y2024)input));
    }

    private static int getLowestScoreReindeer(Day16Y2024 input) {
        return dijkstraWithDirection(input, input.getSPosition(), input.getEPosition());
    }

    private static int dijkstraWithDirection(Day16Y2024 input, Position start, Position end) {
    ...
    private static List<Position> getNeighbors(Day16Y2024 input, Position current) {
    ...
    protected void part2Solution(Object input) {
        System.out.println("SOLUCION: " + getNumOfGoodTilesOptimized((Day16Y2024)input) );
    }

    private static int getNumOfGoodTilesOptimized(Day16Y2024 input) {
        record State(Position pos, String dir) {}
