...
public class Day2Solution2024 extends BaseDay{
    
    @Override
    protected Day2Y2024 getInputData(){
        return Day2Y2024.getDay2Data();
    }

    @Override
    public void runDaySolution(){
        Day2Y2024 input =getInputData();
    ...
    protected void part1Solution(Object input){
        System.out.println("SOLUCION:" + getSafeReports((Day2Y2024)input));
    }

    private static Long getSafeReports(Day2Y2024 input){
    ...
    protected void part2Solution(Object input){
        Long res = getSafeReports((Day2Y2024)input) + getNewSafeReports((Day2Y2024)input);
        System.out.println("SOLUCION:" + res);
    }

    private static Long getNewSafeReports(Day2Y2024 input){
