...
public class Day18Solution {
    ...
    public static void day18Solution(){
        Day18 input = Day18.getDay18Data();
    ...
    private static void part1Solution(Day18 input) {
        Integer minSteps = getMinimumNumberOfStepsToEscape(input) -1;
        System.out.println("SOLUCION: " + minSteps);
    }

    private static Integer getMinimumNumberOfStepsToEscape(Day18 input) {
    ...
    private static void simulateMemoryFall(Day18 input){
    ...
    public static List<Position> getShortestPath(Day18 input, Position start, Position end){
    ...
    private static List<Position> getNeighbors(Day18 input, Position p){
    ...
    private static void part2Solution(Day18 input) {
        System.out.println("SOLUCION: " + findFirstByteToMakeExitUnreachable(input)); 
    }

    private static String findFirstByteToMakeExitUnreachable(Day18 input) {
