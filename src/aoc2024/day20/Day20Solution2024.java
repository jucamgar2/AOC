...
public class Day20Solution2024 extends BaseDay{
    
    @Override
    protected Day20Y2024 getInputData(){
        return Day20Y2024.getDay20Data();
    }

    @Override
    public void runDaySolution(){
        Day20Y2024 input = getInputData();
    ...
    protected void part1Solution(Object input) {
        ...
        System.out.println("SOLUCION: " + getNumberOfGoodCheats((Day20Y2024)input, bestJumpLimit));
    }

    private static Integer getNumberOfGoodCheats(Day20Y2024 input, Integer bestJumpLimit) {
    ...
    private static Boolean canPositionCheat(Position pos, Day20Y2024 input, List<Position> path) {
        return !getDirectionsToCheat(input, pos).isEmpty();
    }

    private static Integer getNumberOfBestJumpsByPosition(Position pos, Day20Y2024 input, List<Position> path, Integer bestJumpLimit) {
    ...
    private static Set<Position> getDirectionsToCheat(Day20Y2024 input, Position pos){
    ...
    private static void addIfCheat(Day20Y2024 input, Set<Position> positionsToCheat,
                               int i1, int j1) {
    ...
    private static List<Position> getPath(Day20Y2024 input){
    ...
    private static List<Position> getNeighbors(Day20Y2024 input, Position p){
        int i = p.getI();
        int j = p.getJ();
    ...
    protected void part2Solution(Object input) {
        Integer bestJumpLimit =100;
        System.out.println("CHEATS TO SAVE " + bestJumpLimit + " PICOSECONDS");
        System.out.println("SOLUCION: " + getNumberOfGoodCheatsPart2((Day20Y2024) input, bestJumpLimit));
    }

    private static Integer getNumberOfGoodCheatsPart2(Day20Y2024 input, Integer bestJumpLimit){
        List<Position> path = getPath(input);
        return path.stream()
    ...
    private static Integer getNumberOfBestJumpsByPositionPart2(Position pos, Day20Y2024 input, List<Position> path, Integer bestJumpLimit) {
        Integer indexOfActualPosition = path.indexOf(pos);
    ...
    private static List<Position> getPositionsInCheatRange(Position p, Day20Y2024 input){
