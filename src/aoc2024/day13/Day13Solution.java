...
public class Day13Solution {
    ...
    public static void day13Solution(){
        Day13 input = Day13.getDay13Data();
    ...
    public static void part1Solution(Day13 input){
        System.out.println("SOLUCION: " + getMinimunCostForMaximunWin(input));
    }

    public static Integer getMinimunCostForMaximunWin(Day13 input){
    ...
    public static void part2Solution(Day13 input){
        System.out.println("SOLUCION: " + getMinimunCostForMaximunWinBigObj(input));
    }

    public static Long getMinimunCostForMaximunWinBigObj(Day13 input){
