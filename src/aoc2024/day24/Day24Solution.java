...
public class Day24Solution {
    ...
    public static void getDay24Solution(){
        Day24 input = Day24.getDay24Data();
        System.out.println("--------------------------PART1--------------------------");
        part1Solution(input);
        System.out.println("--------------------------PART2--------------------------");
        input = Day24.getDay24Data();
        part2Solution(input);
    }

    private static void part1Solution(Day24 input) {
        System.out.println("SOLUCION: " + getZwiresOutput(input));
    }

    private static Long getZwiresOutput(Day24 input) {
    ...
    private static void part2Solution(Day24 input) {
        System.out.println("SOLUCION: " + getWiresToSwap(input));
    }

    private static String getWiresToSwap(Day24 input) {
