...
public class Day24Y2024 {
    ...
    public Day24Y2024(Map<String, Integer> values, Map<String, BitOperation> operations){
        this.values = values;
        this.operations = operations;
    }

    public static Day24Y2024 getDay24Data(){
        ...
        return new Day24Y2024(values, operations);
    }
}
