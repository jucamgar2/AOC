...
public class Day8Solution {
    ...
    private static void part1Solution(Day8 input){
        System.out.println("SOLUCION: " + generateAntinodeMap(input,false));
    }

    private static Long generateAntinodeMap(Day8 input, Boolean isPart2){
        Day8 antiNodeMap = input.deepCopy();
    ...
    private static void generateAntinodesByFrequence(List<Position> antennas, Day8 antinodeMap, Integer maxI, Integer maxJ, Boolean isPart2){
    ...
    private static void generateAntiNode(Day8 antinodeMap, Position p1, Position p2, Integer maxI, Integer maxJ, Boolean isPart2){
    ...
    private static void part2Solution(Day8 input){
        System.out.println("SOLUCION: " + generateAntinodeMap(input, true));
    }

    private static void generateNodesOfPart2(Day8 antinodeMap, Position p1, Position p2, Integer maxI, Integer maxJ,
