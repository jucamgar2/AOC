...
public class Day3Solution2024 extends BaseDay {

    @Override
    protected Day3Y2024 getInputData(){
        return Day3Y2024.getDay3Data();
    }
    
    @Override
    public  void runDaySolution(){
        Day3Y2024 input = getInputData();
    ...
    protected void part1Solution(Object input){
        System.out.println("SOLUCION: " + getProgramResult((Day3Y2024)input));
    }

    private static Long getProgramResult(Day3Y2024 input){
    ...
    protected void part2Solution(Object input){
        System.out.println("SOLUCION: " + getProgramResultWithConditions((Day3Y2024)input));
    }

    private static Long getProgramResultWithConditions(Day3Y2024 input){
